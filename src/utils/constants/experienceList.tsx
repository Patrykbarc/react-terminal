...
export const experience: Experience[] = [
	{
		...
		text: (
			<>
				<li>Design of sports, business and occasional awards Visualization of products</li>
				<li>DTP</li>
	...
	},
	{
		...
		text: (
			<>
				<li>
					I designed and created an internal product configurator, enabling the company's employees
					to create tasks quickly and easily
				</li>
				<li>
