...
export function TerminalBodyWrapper({ children }: { children: ReactNode }) {
	return (
		<div className='relative size-full max-h-[1024px] min-h-72 min-w-[70vw] max-w-screen-lg resize-y overflow-hidden rounded-b-xl border border-gray-400 caret-gray-600 shadow-2xl md:min-w-[500px] lg:w-[550px] lg:min-w-72 lg:resize'>
