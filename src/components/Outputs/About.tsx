...
export function About({ setInput }: SetStateProps<string>) {
  return (
    <div className="flex flex-col gap-3">
      ...
      <p>
        I am a professional web developer with commercial experience in
        fullstack programming and web design.
      </p>
      <p>
        I have 3.5 years of experience as a graphic designer and a bachelor's
        degree in "Computer Graphics and Multimedia Production".
      </p>
      <p>
        I possess strong creative and analytical skills. I am also a team player
